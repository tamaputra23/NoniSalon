...
public class RetouchLashActivity extends BaseActivity implements View.OnClickListener {
    int natural, lebat, dobel, russian, totalitem, totalprice = 0;
    int naturalPrice = 50000;
    int lebatPrice = 50000;
    int dobelPrice = 50000;
    int russianPrice = 40000;
    ...
    LinearLayout btn_addLebat, btn_addNatural, btn_addDoubel, btn_addRussian, btn_retouchCart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retouch_lash);
        ...
        tv_naturallash.setText("Bottom Lash");
        tv_doublelash.setText("Remove Lash");
        tv_lebatlash.setText("Under Lash");
        tv_russianlash.setText("Retouch Lash");
        tv_totalVolume = findViewById(R.id.tv_totalretouch);
        ...
        btn_retouchCart = findViewById(R.id.btn_retouchcart);
        ...
        btn_retouchCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if(dobel!= 0){
                    writeNewPost(userId, treatment, "Remove Lash", String.valueOf(dobelPrice), String.valueOf(dobel));
                }
                if(natural!= 0){
                    writeNewPost(userId, treatment, "Bottom Lash", String.valueOf(naturalPrice), String.valueOf(natural));
                }
                if(russian!= 0){
                    writeNewPost(userId, treatment, "Retouch Lash", String.valueOf(russianPrice), String.valueOf(russian));
                }
                if(lebat!= 0){
                    writeNewPost(userId, treatment, "Under Lash", String.valueOf(naturalPrice), String.valueOf(natural));
                }
            }
        });
    }
